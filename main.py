...
import json
phone_book = []
phone_book_file = '2_Block\PythonRepository\phonebook.json' # Название и расположение файла записной книги в формате JSON
...
def save_phone_book(phone_book, phone_book_file = '2_Block\PythonRepository\phonebook.json'):
    # """
    # Функция сохраняет список контактов в файл JSON

    # Args: 
    #     phone_book (list): список контактов
    #     phone_book_file (str) = "2_Block\PythonRepository\phonebook.json": строка с названием файла (значение по умолчанию)
    # """
...
def save_contacts_to_txt(contacts, file_name = '2_Block\PythonRepository\phone_book.txt'):
    # """
    # Функция для сохранения контактов в файл txt

    # Args:
    #     contacts (list)
    #     file_name  = "2_Block\PythonRepository\phone_book.txt" (str): будущее название файла !!! разрешение .txt
    # """
    if contacts == None:
        os.system('cls||clear')
        print("По данному запросу нет контактов для отображения")
